...
if (typeof _user$project$PhotoGroove$main !== 'undefined') {
    _user$project$PhotoGroove$main(Elm['PhotoGroove'], 'PhotoGroove', {"types":{"unions":{"PhotoGroove.ThumbnailSize":{"args":[],"tags":{"Small":[],"Large":[],"Medium":[]}},"PhotoGroove.Msg":{"args":[],"tags":{"SetSize":["PhotoGroove.ThumbnailSize"],"SelectByUrl":["String"],"SurpriseMe":[]}}},"aliases":{},"message":"PhotoGroove.Msg"},"versions":{"elm":"0.18.0"}});
}
